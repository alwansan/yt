...
APP_ID: int = int(os.getenv("APP_ID", 22004639))
APP_HASH = os.getenv("APP_HASH", "bc9b7c9b66e1dd9e046825a53cd623c2")
TOKEN = os.getenv("TOKEN", "7609852033:AAFtY-_MNF2FAd1WeVyskPggCCsDrFsscL4")
